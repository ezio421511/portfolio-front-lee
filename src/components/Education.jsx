  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
              ...
              <div key={edu.id} className="relative group">
                ...
                <div className={`ml-0 md:ml-20 transform transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 ${
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                    ...
                    {/* GPA/Score Card */}
                    <div className={`mt-4 lg:mt-0 lg:ml-6 p-4 rounded-xl border-2 border-dashed min-w-[140px] text-center transition-colors ${
                      darkMode 
        ...
        {/* Footer Note */}
        <div className={`text-center mt-16 p-6 rounded-lg ${
          darkMode 
